...
public class Btree<T extends Comparable<T>> implements Tree<T> {
    ...
    public Btree<T> podarDer(Nodo<T> n, Btree<T> dest) {
        if (n != null) {
            dest.root = null;
            dest.root = n.getRight();
            if (dest.root != null) {
                n.setRight(null);
            }
        }
    ...
    public Btree<T> insertarIzq(Nodo<T> n, Btree<T> rama) {
        if (rama == null) {
            return null;
        }
        if (n != null) {
    ...
    public Btree<T> insertarDer(Nodo<T> n, Btree<T> rama) {
        if (rama == null) {
            return null;
        }
        if (n != null) {
